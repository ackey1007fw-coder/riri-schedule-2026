...
export const events: ScheduleEvent[] = [
  ...
  },
  {
    ...
    summary:
      "即興劇ユニット『天竺生地』vol.28に出演。里季さんの出演日は10月11日（日）、会場は池袋西口GEKIBA。同日は第一回12:00〜／第二回15:30〜／第三回18:30〜の3回公演で、キャスト発表第一弾では日付単位の案内です。MCは斎藤このむ・緑川睦。稽古なしの即興劇で、里季さん自身「初挑戦」と投稿しています。チケット情報は確認でき次第掲載します。",
