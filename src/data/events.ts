...
export const events: ScheduleEvent[] = [
  {
    ...
    summary:
      "劇団ココアの19世紀イギリス風恋愛喜劇『ピッパラの樹』にA班「アナスタジー・ド・ブロワ役」として出演（約100分）。脚本・演出：小谷聡一郎。りりの出演回は 8/18(火)19:30｜8/22(土)12:00｜8/23(日)15:30｜8/25(火)14:00｜8/28(金)19:30｜8/29(土)19:30 の全6公演。特典付き優先入場チケット5,500円／一般4,500円（全席自由席）。ご予約の際は備考欄に「夏凪里季」とご記入ください。8/9時点で満席・残りわずかの回が出ています。詳しい特集は「舞台『ピッパラの樹』」セクションでご紹介しています。",
