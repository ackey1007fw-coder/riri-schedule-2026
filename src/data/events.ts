...
export const events: ScheduleEvent[] = [
  {
    ...
    summary:
      "劇団ココアの19世紀イギリス風恋愛喜劇『ピッパラの樹』にA班「アナスタジー・ド・ブロワ役」として出演（約100分）。脚本・演出：小谷聡一郎。りりの出演回は 8/18(火)19:30｜8/22(土)12:00｜8/23(日)15:30｜8/25(火)14:00｜8/28(金)19:30｜8/29(土)19:30 の全6公演。特典付き優先入場チケット5,500円／一般4,500円（全席自由席）。ご予約の際は備考欄に「夏凪里季」とご記入ください。2026年8月29日の劇団ココア公式Xより、A班千秋楽は満席で終了しています。詳しい特集は「舞台『ピッパラの樹』」セクションでご紹介しています。",
    badges: ["舞台", "A班", "全6公演", "A班千秋楽終了"],
    links: [
      {
        label: "チケット予約（tiget）",
  ...
  },
  {
    ...
    summary:
      "アイトキシリーズ第2弾、名曲から生まれた5つの短編集『I'm talking about Homin'』にA sideとして出演。脚本・演出：中平奈緒・もか・横大路伸。りりの出演回は 9/11(金)19:00｜9/12(土)12:00｜9/13(日)12:00｜9/15(火)18:00 の全4公演。前売券6,000円／当日券6,500円。9/11本人Xより当日券あり。9/11(金)19:00回の開場は18:40。9/12本人Xより、9/12(土)12:00回の開場は11:40、当日券販売は11:30。制作Xより全回で若干数の当日券（開場10分前販売・劇場外待機）。9/12 12:00回は残席少（制作X：残り4席 / 2026-09-05確認）。変動するので販売ページを正とする。公演に先立ち、9/8(火)17:00〜17:20は制作アカウントのツイキャスに里季さんが出演します（約10〜20分）。",
    badges: ["舞台", "A side", "全4公演", "9/12 開場11:40", "9/12 当日券11:30", "9/12 12:00残席少", "アイトキ第2弾"],
    links: [
      {
      ...
      {
        label: "A side 2ステ目・開場11:40（9/12）",
        url: "https://x.com/frecam2025_0306/status/2098561013679624620",
        kind: "sns"
      },
      {
        label: "全回当日券・開場10分前販売（9/12・制作X）",
        url: "https://x.com/kaigyacstage/status/2098523626945597884",
        kind: "sns"
      },
      {
        label: "A班初日・当日券あり（9/11）",
  ...
  },
  {
    ...
    summary:
      "月シア上映イベント『月を跨ぐvol.20』に、昼の部（13:00）・夕方の部（17:00）の両部へ出演。月シア別冊第2集『I'm talking about Homin'』の全5話をキャストと一緒に見て、裏話を語るトークショーです。会場は下北沢RBLCAFE。チケットは販売中です。お席数が限られているため、本人も早めの予約を案内しています。来場者限定で、キャスト全員のサイン入りA1ポスター抽選と、イベント出演者の撮り下ろしサイン入りチェキのプレゼント企画もあります。",
    badges: ["上映イベント", "トークショー", "昼・夕両部出演", "チケット販売中"],
    reportQuote:
    ...
    reportNote:
      "本人X（2026年9月19日）の出演告知です。チケットは販売中です。",
    links: [
      {
        label: "チケット販売ページ（販売中）",
