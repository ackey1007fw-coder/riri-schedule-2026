...
export const events: ScheduleEvent[] = [
  {
    ...
    summary:
      "劇団ココアの19世紀イギリス風恋愛喜劇『ピッパラの樹』にA班「アナスタジー・ド・ブロワ役」として出演（約100分）。脚本・演出：小谷聡一郎。りりの出演回は 8/18(火)19:30｜8/22(土)12:00｜8/23(日)15:30｜8/25(火)14:00｜8/28(金)19:30｜8/29(土)19:30 の全6公演。特典付き優先入場チケット5,500円／一般4,500円（全席自由席）。ご予約の際は備考欄に「夏凪里季」とご記入ください。2026年8月28日の本人投稿では、8/29(土)19:30の千秋楽は満席、飛び込み可能なのは8/28(金)19:30のみとの案内です。詳しい特集は「舞台『ピッパラの樹』」セクションでご紹介しています。",
    badges: ["舞台", "A班", "全6公演", "8/29千秋楽満席", "8/28飛び込み可"],
    links: [
      {
        label: "チケット予約（tiget）",
