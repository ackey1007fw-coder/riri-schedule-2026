...
export const news: NewsItem[] = [
  {
    date: "2026.9.1",
    label: "X",
    text: "「#アイトキ #ホーミン 本日顔合わせ読み合わせでした✨️ オムニバス形式の公演となるので色んなりりが見れちゃいますよ👀」月シア別冊第2集『I'm talking about Homin'』の顔合わせ・読み合わせ。出演は Aside。公演日時・会場は既存のまま（9/11 19:00・9/12 12:00・9/13 12:00・9/15 18:00、西荻窪 遊空間がざびぃ）。",
