...
export const news: NewsItem[] = [
  {
    date: "2026.8.31",
    label: "X",
    text: "「9月の舞台 #アイトキ デジタル花の販売が明日までとなっております！！ 現地に来られない方も応援できるシステムです✨ 夏凪がんばれって思ってくれてるそこの貴方！とってもとっても力になるのでよければご検討ください こちらから⬇️(2種類あるよ)」月シア別冊第2集『I'm talking about Homin'』のデジタル花。販売は2026年9月1日(火)23:59まで。ショップ https://tsukitheater.base.ec/ （2種類）",
