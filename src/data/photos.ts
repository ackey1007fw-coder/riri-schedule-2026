...
export const galleryPhotos: GalleryPhoto[] = [
  ...
  { src: "/images/gallery/g109.jpg", alt: "『ピッパラの樹』舞台衣装でキャストと撮影したコラボショット。白いミニハットに青緑のベスト姿と、チェックのベストにネクタイ姿" },
  { src: "/images/gallery/g110.jpg", alt: "『ピッパラの樹』舞台衣装でキャストと撮影したコラボショット。白いミニハットに青緑のベスト姿と、茶色のベストにネクタイ姿" },
...
export const galleryUpdate: {
  ...
  date: "2026.8.17",
  platform: "X",
  note: "『ピッパラの樹』コラボチェキのおすすめ。舞台衣装でのコラボショット2枚",
