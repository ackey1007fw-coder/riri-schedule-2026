...
export const galleryPhotos: GalleryPhoto[] = [
  ...
  { src: "/images/gallery/g115.jpg", alt: "夜の屋外の木製階段に立つ夏凪里季さんの全身が分かる縦写真。白いノースリーブのトップスにライトブルーのデニム、淡い色のショルダーバッグ。手すりにイルミネーション、背景に都市の夜景（原宿・Instagramより）" },
  { src: "/images/gallery/g116.jpg", alt: "カメラに近い構図で、片手を髪付近に添えた夏凪里季さん。白いノースリーブのトップスにデニム、淡い色のショルダーバッグ。背景はイルミネーションの灯る夜の階段と都市の夜景（原宿・Instagramより）" },
  { src: "/images/gallery/g117.jpg", alt: "イルミネーションの灯る手すりに片手を置き、横方向へ視線を向けた夏凪里季さん。白いノースリーブのトップスにデニム、淡い色のショルダーバッグ。背景は夜の都市の夜景（原宿・Instagramより）" },
