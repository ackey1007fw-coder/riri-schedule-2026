...
export const galleryPhotos: GalleryPhoto[] = [
  ...
  { src: "/images/gallery/g111.jpg", alt: "白いミニハットとストライプのブラウス、青いベストの衣装でウインクし、右手の人差し指を立てている夏凪里季さん" },
  { src: "/images/gallery/g112.jpg", alt: "白いミニハットと青緑のベスト姿の夏凪里季さん（右）と、白いレースのカチューシャ姿の共演者（左）。二人とも頬付近に手を添えている2ショット" },
  { src: "/images/gallery/g113.jpg", alt: "白いミニハットと青緑のベスト姿の夏凪里季さん（右）と、白いレースのカチューシャ姿の共演者（左）。木目の壁の前での2ショット" },
...
export const galleryUpdate: {
  ...
  date: "2026.8.18",
  platform: "X",
  note: "『ピッパラの樹』A班初日公演後の舞台衣装ショット3枚",
