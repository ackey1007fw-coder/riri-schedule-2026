...
export const galleryPhotos: GalleryPhoto[] = [
  ...
  { src: "/images/gallery/g86.jpg", alt: "夜の駅構内で、お友達と肩を寄せ合って笑顔の2ショット自撮り。夏凪里季さんは白いレース襟のブラウス姿" },
  { src: "/images/gallery/g87.jpg", alt: "同じ場所での2ショット自撮り。夏凪里季さんの隣でお友達がピースサインを見せている" },
